...
<template>
  <div class="bg-white relative pt-40 pb-20 lg:pt-44 dark:bg-gray-900">
    <div class="relative xl:container m-auto px-6 md:px-12 lg:px-6">
        <h1 class="sm:mx-auto sm:w-10/12 md:w-2/3 font-black text-blue-900 text-4xl text-center sm:text-5xl md:text-6xl lg:w-auto lg:text-left xl:text-7xl dark:text-white">We Are Always Here For <br class="lg:block hidden">All Your Pet's <br class="lg:block hidden">Good Health.</h1>
        <div class="lg:flex">
