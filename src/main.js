...
import { faBone, faBowlFood, faLightbulb, faPrescriptionBottleMedical, faUser, faUserSecret, faXmark } from '@fortawesome/free-solid-svg-icons'

/* add icons to the library */
library.add(faUserSecret, faUser, faLightbulb, faCircleUser, faXmark, faBowlFood, faPrescriptionBottleMedical)
